...
<style>
  ...
  .fp-radio-label-wrapper:hover .fp-radio-input ~ .fp-radio-checkmark {
  ...
  .fp-radio-label-wrapper:hover .fp-radio-input:checked ~ .fp-radio-checkmark {
      -webkit-box-shadow: var(--box-shadow-primary);
              box-shadow: var(--box-shadow-primary);
    }
  /* Hide the browser's default radio button. */
  .fp-radio-label-wrapper .fp-radio-input {
      position: absolute;
      opacity: 0;
      cursor: pointer;
      height: 0;
  ...
  .fp-radio-label-wrapper .fp-radio-input:checked ~ .fp-radio-checkmark {
        border-color: var(--primary-color);
        background-color: var(--primary-color);
      }
  /* Show the checkmark when checked. */
  .fp-radio-label-wrapper .fp-radio-input:checked ~ .fp-radio-checkmark:after {
        display: block;
      }
  /* Create a custom radio button. */
  .fp-radio-label-wrapper .fp-radio-checkmark {
      position: absolute;
      left: 0;
      height: 25px;
      width: 25px;
  ...
  .fp-radio-label-wrapper .fp-radio-checkmark:after {
  ...
  .fp-radio-label-wrapper .fp-radio-input:disabled ~ .fp-radio-checkmark {
  ...
  .fp-radio-label-wrapper:hover .fp-radio-input:disabled ~ .fp-radio-checkmark {
