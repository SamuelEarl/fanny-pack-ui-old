...
<script lang="ts">
  ...
  onMount(() => {
    ...
    /* Look for any elements with the class "fpui-select-container": */
    let selectContainer = document.getElementsByClassName("fpui-select-container");
...
<div class="fpui-select-container">
