...
<div class="fpui-multi-select"> 
  ...
  <div
    ...
    on:blur={(event) => {
      ...
      // This is basically saying if the user clicks on the select-btn or on one of the select-all-btns or a checkbox, then do not hide the selectMenu. If the user clicks the select-btn, then the select-btn's on:click event will hide the selectMenu.
